        ...
        <form action={formAction} className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              name="snapshot_month"
              required
              className="h-10 rounded-lg border border-black/[.08] bg-white px-3 text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-black/20 dark:border-white/[.1] dark:bg-zinc-900 dark:focus:ring-white/20"
            />
          </div>
